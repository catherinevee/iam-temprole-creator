...
class DynamoDBManager:
    ...
    def log_audit_event(self, audit_log: AuditLog) -> bool:
        ...
        try:
            ...
            audit_table = self.dynamodb.Table("iam-role-vendor-audit-logs")
    ...
    def _item_to_session(self, item: Dict[str, Any]) -> Optional[RoleSession]:
        ...
        try:
            ...
            if 'requested_at' in mapped_item:
                mapped_item['requested_at'] = datetime.fromisoformat(mapped_item['requested_at'].replace('Z', '+00:00'))
            if 'expires_at' in mapped_item:
                mapped_item['expires_at'] = datetime.fromisoformat(mapped_item['expires_at'].replace('Z', '+00:00'))
